		...
		<section className="py-10 sm:py-16 bg-white">
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              `,
					...
					{/* Dynamic Info Box */}
					<div className="relative sm:absolute bottom-0 sm:-bottom-10 sm:left-1/2 sm:-translate-x-1/2 bg-primary-green text-white p-4 rounded-lg w-full sm:max-w-xs transition-all duration-500 ease-in-out z-10">
